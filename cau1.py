...
Cách 2 (Dùng toán học): Trong khi $n$ còn lớn hơn 0, lấy chữ số hàng đơn vị bằng phép chia lấy dư cho 10 ($n \pmod{10}$), cộng vào biến tổng, sau đó cắt bỏ chữ số hàng đơn vị bằng phép chia lấy nguyên cho 10 ($n \div 10$).
